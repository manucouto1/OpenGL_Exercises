...
void myRotate(T_rotXYZ direccion){
    glRotatef(direccion.x, 1.0f, 0.0f, 0.0f);
    glRotatef(direccion.y, .0f, 1.0f, 0.0f);
    glRotatef(direccion.z, .0f, 0.0f, 1.0f);
}

// Primera articulación
void articula(T_rotXYZ rot){
...
void figura(T_rotXYZ rot1, T_rotXYZ rot2){
    glColor3f(1.0f, 0.0f, 1.0f); // Magenta
    articula(rot1); // Primera articulación

    glTranslatef(.0f,-1.0f, 0.0f); // Desplazamos la segunda estructura
    
    glColor3f(0.0f, 1.0f, 1.0f); //cyan
    articula(rot2); // Segunda articulación
}
